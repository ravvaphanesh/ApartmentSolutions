...
<%
	String appphoneno=request.getParameter("amount");
	String appid=request.getParameter("status");
try
{
	...
	String qry="update problem set amount='"+amount+"' where appid='"+appid+"' and flatno='"+flatno+"'";
